...
console.log(`${numsRandomOrder} equals ${insertionSort(numsRandomOrder)} after sorting. Expected: ${expected}.`);
console.log(`${numsReversed} equals ${insertionSort(numsReversed)} after sorting. Expected: ${expected}.`);
console.log(`${numsOrdered} equals ${insertionSort(numsOrdered)} after sorting. Expected: ${expected}.`);
